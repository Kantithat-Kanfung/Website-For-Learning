    ...
    <div class="container content" style="margin-top: 100px; margin-bottom: 50px">
        <div class="w3-row">
            <div class="w3-col s6 w3-white w3-center">
                <img src="img/img__vermicelli__salad.png" style="width: 475px; height: 475px">
            </div>
            <div class="w3-col s6 w3-white ">
                <h3>ตำวุ้นเส้นกุ้งสด</h3>
                <h4>ส่วนผสม</h4>
                <ul>
                    <li>วุ้นเส้น (Glass Noodle) - 200g</li>
                    <li>กุ้งสด (Shrimps) - as you wish</li>
                    <li>ถั่วฝักยาว (Long beans) - as you wish</li>
                    <li>น้ำปลา (Fish Suace) - 2tbsp</li>
                    <li>มะเขือเคือ (Tiny Tomato)</li>
                    <li>น้ำปลาร้า (Fermented Fish Sauce) - 1/4cup</li>
                    <li>น้ำตาลปี๊บ (Palm Sugar) - 1/2tbsp</li>
                    <li>พริกแห้ง (Dried Chilli) - as you wish</li>
                    <li>กระเทียม (Garlic) - 3 เม็ด</li>
                    <li>น้ำมะนาว (Lime Juice) - 3tbsp</li>
                </ul>
                <h4>วิธีทำ</h4>
                <ol>
                    <li>คลกพริกแห้ง กระเทียมให้ละเอียด</li>
                    <li>จากนั้นใส่น้ำปลา น้ำปลาร้า มะนาว น้ำตาลปี๊บ มะเขือเคือ ถั่วฝักยาวลงไป</li>
                    <li>คลุกเคล้าส่วนผสมให้เข้ากัน</li>
                    <li>ใส่วุ้นเส้นและกุ้งลงไปตำให้ส่วนผสมเข้ากัน</li>
