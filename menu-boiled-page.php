...
<body class="animated fadeIn slower">
    ...
    <div class="w3-container" style="margin-top: 50px">
        <h2 class="w3-center" style="margin: 50px 0 20px 0">เมนูประเภท - ต้ม</h2>
        <!-- Grid layout -->
        <div class="row">
            <div class="column w3-center" style="background-color:#fff;">
                <!-- ต้มแซ่บเอ็นแก้ว -->
                <a href="#fried-frog.php">
                    <h3 class="">ต้มแซ่บเอ็นแก้ว</h3>
                    <img src="img/img-boiled-page/img__Spicy__%20pork__%20tendon__%20soup.png" style="width: 300px; height: 300px" alt="ต้มแซ่บเอ็นแก้ว">
                </a>
                <p>อาหารประเภท : ต้ม</p>
            ...
            <div class="column w3-center" style="background-color: #fff;">
                <a href="#Roasted-pork.php">
                    <h3>แกงอ่อมหนังควาย</h3>
                    <img src="img/img-boiled-page/img__boiled__buffalo__leather.PNG" style="width: 300px; height: 300px" alt="แกงอ่อมหนังควาย">
                </a>
                <p>อาหารประเภท : ต้ม</p>
                <p>อัพเดทเมื่อวันที่ : 7-พฤษภาคม-2562</p>
            </div>
            ...
            <div class="column w3-center" style="background-color: #fff;">
                <a href="#Boiled-chicken-legs.php">
                    ...
                    <img src="img/img-boiled-page/img__Boiled__%20chicken__%20legs.png" style="width: 300px; height: 300px" alt="ซุปเปอร์ตีนไก่">
                </a>
                <p>อาหารประเภท : ต้ม</p>
                <p>อัพเดทเมื่อวันที่ : 7-พฤษภาคม-2562</p>
            </div>
