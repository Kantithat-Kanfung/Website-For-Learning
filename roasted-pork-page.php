    ...
    <div class="container content" style="margin-top: 100px; margin-bottom: 50px">
        <div class="w3-row">
            <div class="w3-col s6 w3-white w3-center">
                <img src="img/img__Roasted__pork.png" style="width: 475px; height: 475px">
            </div>
            <div class="w3-col s6 w3-white ">
                <h3>สามชั้นคั่วกลิ้ง</h3>
                <h4>ส่วนผสม</h4>
                <ul>
                    <li>หมูสามชั้น (Streaky Pork) - 300g</li>
                    <li>พริกแกงคั่ว (Roasted Chilli Pas) - 2tbsp</li>
                    <li>กะปิ (Shrimp Paste) - 10g</li>
                    <li>พริกไทย (Pepper) - 1tbsp</li>
                ...
                <h4>วิธีทำ</h4>
                <ol>
                    <li>นำพริกแกงคั่ว กะปิ พริกไทยลงไปคลกในครกให้เข้ากัน</li>
                    <li>นำเนื้อหมูสามชั้นที่หั่นแล้วไปผัดกับพริกแกงคั่ว</li>
                    <li>ใส่ใบกรูดซอยลงไป</li>
