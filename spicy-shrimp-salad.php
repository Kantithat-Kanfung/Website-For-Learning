    ...
    <div class="container content" style="margin-top: 100px; margin-bottom: 50px">
        <div class="w3-row">
            <div class="w3-col s6 w3-white w3-center">
                <img src="img/img__%20Spicy__shrimp__salad.png" style="width: 475px; height: 475px">
            </div>
            <div class="w3-col s6 w3-white ">
                <h3>ยำกุ้งแห้ง</h3>
                <h4>ส่วนผสม</h4>
                <ul>
                    <li>กุ้งแห้ง (Dried Shrimp) - 150g</li>
                    <li>หมูยอ (Processed Pork) - 60g</li>
                ...
                <ol>
                    ...
                    <li>นำหมูยอไปหั่นเป็นชิ้นพอดีคำ ใส่ลงไปผสมในภาชนะคลุกเคล้าให้เข้ากันกับส่วนผสมอื่นๆ</li>
                    <li>สุดท้ายใสกุ้งแห้งลงไปผสมด้วย</li>
