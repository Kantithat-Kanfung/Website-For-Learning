    ...
    <div class="container content" style="margin-top: 100px; margin-bottom: 50px">
        <div class="w3-row">
            <div class="w3-col s6 w3-white w3-center">
                <img src="img/img__Spicy__%20pork__%20tendon__%20soup.png" style="width: 475px; height: 475px">
            </div>
            <div class="w3-col s6 w3-white ">
                <h3>ต้มแซ่บเอ็นแก้ว</h3>
                <h4>ส่วนผสม</h4>
                <ul>
                    <li>น้ำเปล่า (ฺBoiled Water) - 1.5L</li>
                    <li>ตะไคร้ (Lemon Glass) - as you wish</li>
                    <li>ข่า (GalanGal) - as you wish</li>
                    <li>ใบมะรูด (Sliced Kaffir Lime Leaves) - 20g</li>
                    <li>หอมแดง (Spring Onions) - 5 ลูก</li>
                    <li>มะขามเปียก (Tamarin) - 50g</li>
                    <li>เอ็นแก้ว (Beef Tendon) - 500g</li>
                    <li>น้ำปลา (Fish Suace) - 2tbsp</li>
                    <li>พริกขี้หนูสับ (Chilli) - as you wish</li>
                    <li>พริกแห้ง (Dried Chilli) - as you wish</li>
                    <li>ผักชีฝรั่ง (Sliced Culantro)</li>
                </ul>
                <h4>วิธีทำ</h4>
                <ol>
                    <li>นำเนื้อไปล้างน้ำให้สะอาด</li>
                    <li>ต้มน้ำให้เดือด</li>
                    <li>จากนั้นใส่ตะไคร้ ข่า ใบมะรูด หอมแดง มะขามเปียก ลงไปต้ม</li>
                    <li>ใส่เนื้อเอ็นแก้วลงไป ตามด้วยน้ำปลา พริกขี้หนูสับ พริกแห้ง ผักชีฝรั่ง</li>
                    <li>ต้มทิ้งไว้ 1 ชม.</li>
                    <li>ตักใส่จานพร้อมขึ้นเสริฟ</li>
                </ol>
