...
<body class="animated fadeIn slower">
    ...
    <div class="w3-container" style="margin-top: 50px">
        <h2 class="w3-center" style="margin: 50px 0 20px 0">เมนูประเภท - ทอด</h2>
        <!-- Grid layout -->
        <div class="row">
            <div class="column w3-center" style="background-color:#fff;">
                ...
                <a href="#fried-frog.php">
                    <h3 class="">ลาบทอด</h3>
                    <img src="img/img-fried-page/img__fried__Laab.PNG" style="width: 300px; height: 300px" alt="ลาบทอด">
                </a>
                <p>อาหารประเภท : ทอด</p>
            ...
            <div class="column w3-center" style="background-color: #fff;">
                <a href="#Roasted-pork.php">
                    <h3>ดักแด้ทอด</h3>
                    <img src="img/img-fried-page/img__fried__pupa.PNG" style="width: 300px; height: 300px" alt="ดักแด้ทอด">
                </a>
                <p>อาหารประเภท : ทอด</p>
                <p>อัพเดทเมื่อวันที่ : 7-พฤษภาคม-2562</p>
            </div>
            ...
            <div class="column w3-center" style="background-color: #fff;">
                <a href="#Boiled-chicken-legs.php">
                    <h3>ตีนไก่ชุปแป้งทอด</h3>
                    <img src="img/img-fried-page/img__fried__chicken.PNG" style="width: 300px; height: 300px" alt="ตีนไก่ชุปแป้งทอด">
                </a>
                <p>อาหารประเภท : ทอด</p>
                <p>อัพเดทเมื่อวันที่ : 7-พฤษภาคม-2562</p>
            </div>
