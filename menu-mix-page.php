...
<body class="animated fadeIn slower">
    ...
    <div class="w3-container" style="margin-top: 50px">
        <h2 class="w3-center" style="margin: 50px 0 20px 0">เมนูประเภท - ยำ</h2>
        <!-- Grid layout -->
        <div class="row">
            <div class="column w3-center" style="background-color:#fff;">
                <!-- ยำหมูกรอบ -->
                <a href="#fried-frog.php">
                    <h3 class="">ยำหมูกรอบ</h3>
                    <img src="img/img-mix-page/img__Crispy__pork__salad.png" style="width: 300px; height: 300px" alt="ยำหมูกรอบ">
                </a>
                <p>อาหารประเภท : ยำ</p>
            ...
            <div class="column w3-center" style="background-color: #fff;">
                <a href="#Roasted-pork.php">
                    <h3>ดองปูม้า</h3>
                    <img src="img/img-mix-page/img__horse__crab__salad.png" style="width: 300px; height: 300px" alt="ดองปูม้า">
                </a>
                <p>อาหารประเภท : ยำ</p>
                <p>อัพเดทเมื่อวันที่ : 7-พฤษภาคม-2562</p>
            </div>
            ...
            <div class="column w3-center" style="background-color: #fff;">
                <a href="#Boiled-chicken-legs.php">
                    <h3>ยำมะม่วง</h3>
                    <img src="img/img-mix-page/img__Mango__Salad.png" style="width: 300px; height: 300px" alt="ยำมะม่วง">
                </a>
                <p>อาหารประเภท : ยำ</p>
                <p>อัพเดทเมื่อวันที่ : 7-พฤษภาคม-2562</p>
            </div>
