    ...
    <div class="container content" style="margin-top: 100px; margin-bottom: 50px">
        <div class="w3-row">
            <div class="w3-col s6 w3-white w3-center">
                <img src="img/img__Boiled__%20chicken__%20legs.png" style="width: 475px; height: 475px">
            </div>
            <div class="w3-col s6 w3-white ">
                <h3>ซุปเปอร์ตีนไก่</h3>
                <h4>ส่วนผสม</h4>
                <ul>
                    <li>ตีนไก่ (Chicken Feet) - 500g</li>
                    <li>น้ำเปล่า (ฺBoiled Water) - 2L</li>
                    <li>ซีอิ๊วดำ (Black Soy Sauce) - 2tbsp</li>
                    <li>พริกขี้หนูสับ (Chopped Chilli) - 1/2cup</li>
                    <li>น้ำปลา (Fish Suace) - 2tbsp</li>
                    <li>น้ำตาล (Sugar) - 2tbsp</li>
                    <li>ผักชีฝรั่ง (Sliced Culantro) - 30g</li>
                    <li>น้ำมะนาว (Lime Juice) - 80ml</li>
                </ul>
                <h4>วิธีทำ</h4>
                <ol>
                    <li>นำตีนไก่ไปล้างน้ำเปล่าให้สะอาด</li>
                    <li>ต้มน้ำในหม้อให้เดือด</li>
                    <li>ใส่ตีนไก่ลงไปต้มให้สุก ตุ๋นทิ้งไว้ 1 ชม.</li>
                    <li>ใส่ซีอิ๊วดำลงไปเพื่อเพิ่มสีสันให้น่ารับประทาน</li>
                    <li>ตามด้วยน้ำปลาและน้ำตาลทราย</li>
                    <li>ตุ๋นทิ้งไว้เป้นเวลา 30 นาที</li>
                    <li>เปิดฝาใส่ พริกขี้หนู ผักชีฝรั่งและน้ำมะนาวลงไป</li>
                    <li>สุดท้ายนำขึ้นจัดใส่จานพร้อมเสริฟ</li>
                </ol>
