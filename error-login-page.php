...
<body>
    ...
    <div class="w3-display-middle  w3-text-white">
        <form action="login-page.php" style="max-width:500px;margin:auto">
            
            <h1 class="w3-xlarge" style="text-align: center">กรุณาเข้าสู่ระบบอีกครั้ง</h1>
            ...
            <button class="w3-button w3-border w3-round-xxlarge w3-hover-sand" type="submit">ล็อกอิน</button>
        </form>
    </div>
