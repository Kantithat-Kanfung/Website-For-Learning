    ...
    <div class="container content" style="margin-top: 100px; margin-bottom: 50px">
        <div class="w3-row">
            <div class="w3-col s6 w3-white w3-center">
                <img src="img/img__Pork__with__%20lemon.png" style="width: 475px; height: 475px">
            </div>
            <div class="w3-col s6 w3-white ">
                ...
                <ul>
                    <li>หมู (Pork) - 250g</li>
                    <li>กระเทียมสับ (Chopped Garlic) - 2tbsp</li>
                    <li>พริกจินดาแดง (Chilli) - 40g</li>
                    <li>ใบสะระแหน่ (Peppermint) - 15g</li>
                    <li>น้ำปลา (Fish Sauce) - 1tbsp</li>
                    <li>น้ำมะนาว (Lime juice) - 6tbsp</li>
                    <li>น้ำตาล (Sugar) - 1/2tbsp</li>
                </ul>
                <h4>วิธีทำ</h4>
                <ol>
                    <li>หั่นหมูเป็นชิ้นพอดีคำนำไปลวกให้สุก</li>
                    <li>นำกระเทียม พริก ใบสะระแหน่ ไปปั่นให้ละเอียอด</li>
                    <li>พร้อมทั้งใส่น้ำมะนาว น้ำปลา และน้ำตาลลงไปปั่นด้วย</li>
                    <li>นำน้ำจิ๋มที่ได้ไปราดบนเนื้อหมู</li>
                    <li>จัดจานให้สวยงามพร้อมเสริฟ</li>
                </ol>
