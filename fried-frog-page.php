    ...
    <div class="container content" style="margin-top: 100px; margin-bottom: 50px">
        <div class="w3-row">
            <div class="w3-col s6 w3-white w3-center">
                <img src="img/img__fried_frog.png" style="width: 475px; height: 475px">
            </div>
            <div class="w3-col s6 w3-white ">
                ...
                <ul>
                    <li>เนื้อกบ (Frog)</li>
                    <li>ผงปรุงรส (Seasoning Powder)</li>
                    <li>ซีอิ๋วขาว (Soy Suace)</li>
                    <li>แป้งทอดกรอบ (Crispy Flour)</li>
                    <li>กระเทียม (Garlic)</li>
                </ul>
                <h4>วิธีทำ</h4>
                <ol>
                    <li>สับเนื้อกบขนาดพอดีคำ</li>
                    <li>หมักเนื้อกบด้วยผงปรุงรสตามด้วยซีอิ๋วขาว</li>
                    <li>นวดเนื้อกบให้เข้ากันกับเครื่องปรุงรส</li>
                    <li>ใส่แป้งทอดกรอบผสมลงไปกับเนื้อกบ</li>
                    <li>ตั้งกระทะด้วยไฟอ่อนพร้อมนำเนื้อกบลงไปทอด</li>
                    <li>ทอดให้สุกเหลืองกรอบน่ารับประทาน</li>
                    <li>นำขึ้นจานพร้อมเสริฟ</li>
                </ol>
                <div class="w3-col s1 w3-white">
                    <!-- Facebook -->
                    <a href="http://www.facebook.com/sharer.php?u=fried-frog-page.php" target="_blank">
