...
<body class="animated fadeIn slower">
    ...
    <div class="w3-container" style="margin-top: 50px">
        <h2 class="w3-center" style="margin: 50px 0 20px 0">เมนูประเภท - ปิ้งย่าง</h2>
        <!-- Grid layout -->
        <div class="row">
            <div class="column w3-center" style="background-color:#fff;">
                <!-- ย่างตับไก่ -->
                <a href="#fried-frog.php">
                    <h3 class="">ย่างตับไก่</h3>
                    <img src="img/img-grill-page/img__grill__chicken%20liver.PNG" style="width: 300px; height: 300px" alt="ย่างตับไก่">
                </a>
                <p>อาหารประเภท : ปิ้งย่าง</p>
            ...
            <div class="column w3-center" style="background-color: #fff;">
                <a href="#Roasted-pork.php">
                    <h3>จี่หอยหม่าล่า</h3>
                    <img src="img/img-grill-page/img__grill__shellfish.PNG" style="width: 300px; height: 300px" alt="จี่หอยหม่าล่า">
                </a>
                <p>อาหารประเภท : ปิ้งย่าง</p>
                <p>อัพเดทเมื่อวันที่ : 7-พฤษภาคม-2562</p>
            </div>
            <!-- ย่างเนื้อเสือร้องไห้ -->
            <div class="column w3-center" style="background-color: #fff;">
                <a href="#Boiled-chicken-legs.php">
                    <h3>ย่างเสือร้องไห้</h3>
                    <img src="img/img-grill-page/img__grill__beef.PNG" style="width: 300px; height: 300px" alt="ย่างเนื้อเสือร้องไห้">
                </a>
                <p>อาหารประเภท : ปิ้งย่าง</p>
                <p>อัพเดทเมื่อวันที่ : 7-พฤษภาคม-2562</p>
            </div>
