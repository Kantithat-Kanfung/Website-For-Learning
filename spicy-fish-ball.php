    ...
    <div class="container content" style="margin-top: 100px; margin-bottom: 50px">
        <div class="w3-row">
            <div class="w3-col s6 w3-white w3-center">
                <img src="img/img__Spicy__fish__%20ball.png" style="width: 475px; height: 475px">
            </div>
            <div class="w3-col s6 w3-white ">
                <h3>ยำลูกชิ้น</h3>
                <h4>ส่วนผสม</h4>
                <ul>
                    <li>ลูกชิ้น (Meat Ball)</li>
                    <li>กะหล่ำปี (Cabbage) - 60g</li>
                    <li>พริกขี้หนูสับ (Chopped Chilli) - 60g</li>
                    <li>น้ำปลา (Fish Suace) - 2tbsp</li>
                    <li>น้ำตาล (Sugar) - 1tbsp</li>
                    <li>หอมใหญ่ซอย (Onions) - 30g</li>
                    <li>น้ำมะนาว (Lime Juice) - 6tbsp</li>
                    <li>คื่นช่าย (Celery) - 20g</li>
                    <li>มะเขือเทศ (Tomato) - 30g</li>
                </ul>
                <h4>วิธีทำ</h4>
                <ol>
                    <li>นำลูกชิ้นไปทอดให้สุกแล้วนำขึ้นมาพักไว้</li>
                    <li>เตรียมภาชนะส่วนผสม</li>
                    <li>ใส่น้ำปลา น้ำตาล น้ำมะนาว พริกขี้หนูสับ ลงไปคนให้เข้ากัน</li>
                    <li>หั่นลูกชิ้นให้พอดีคำแล้วใส่ลงไปผสมกับเครื่องปรุงคนให้เข้ากัน</li>
                    <li>ตามด้วยหอมใหญ่ซอย คื่นช่าย มะเขือเทศ กะหล่ำปี คลุกเคล้าให้เข้ากัน</li>
                    <li>ตักใส่จานขึ้นเสริฟพร้อม Snowy ซักป๋อง</li>
                </ol>
